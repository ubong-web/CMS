...
$element_text = ['Active Post', 'Draft Post', 'Comments', 'Pending Comment', 'Users', 'Subscriber', 'Categories'];
$element_count = [$post_count, $post_draft_count, $comment_count, $unapproved_comment_count, $users_count, $user_role_count, $category_count];
